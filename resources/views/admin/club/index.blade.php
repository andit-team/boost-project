...
@slot('pageTitle') Club Information
@endslot 
@slot('page')
                                                  ...
                                                  <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                     ...
                                                     <table class="table">
                                                         ...
                                                         <tr>
                                                            <th>Register office address</th>
                                                            <td>:</td>
                                                            <td>{{$row->re_office_address}}</td>
                                                        </tr>
                                                        <tr>
                                                            <th>Vanue address</th>
                                                            <td>:</td>
                                                            <td>{{$row->vanue_address}}</td>
                                                        </tr>
                                                         <tr>
                                                             <th>Municiplitay & Province</th>
                                                             <td>:</td>
                                                             <td>{{$row->municiplitay_province}}</td>
                                                         </tr>
                                                         <tr>
                                                             <th>municiplitay & Province room</th>
                                                             <td>:</td>
                                                             <td>{{$row->municiplitay_province_room}}</td>
                                                         </tr>
                                                         <tr>
                                                             <th>Name & Surname</th>
                                                             <td>:</td>
