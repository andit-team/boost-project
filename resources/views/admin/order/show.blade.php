                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="right">{{$row->price}}.00 €</td>
                                    </tr> 
                                    @endforeach
                                </tbody>
                            </table>
                            ...
                            <div class="col-lg-4 col-sm-5 ml-auto">
                                <table class="table table-clear">
                                    <tbody>
                                        <tr>
                                            <td class="left">
                                                <strong style="margin-left: 20px!important">Subtotal</strong>
                                            </td>
                                            <td class="right ml-5">{{$totlaPrice}}.00 €</td>
                                        </tr>
                                        {{-- <tr>
                                            <td class="left">
                                        ...
                                        <tr>
                                            <td class="left">
                                                <strong style="margin-left: 20px!important">Total</strong>
                                            </td>
                                            <td class="right">
                                                <strong>{{$totlaPrice}}.00 €</strong>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
