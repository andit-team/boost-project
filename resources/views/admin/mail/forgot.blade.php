      ...
      <div class="container">
        ...
        ">
          <div class="container">
              ...
              <div class="text-left">
                <h4>Are You Forgot Your Password</h4>
                </div>
              <div>
            ...
            <div>
                <p class="body-content mt-4 ">
                    We always save your information safely <a href="{{url('reset_password/'.'?email='.$user->email.'&token='.$reminder)}}">click here to reset your password</a>.
                </p> 
            </div>
            <div>
                <p class="body-content mt-4 ">
