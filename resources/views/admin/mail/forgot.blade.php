   ...
   <center>
    <table align="center" border="0" cellpadding="0" cellspacing="0" height="100%" id="bodyTable" style="border-collapse: collapse; mso-table-lspace: 0;
      ...
      <tr>
       ...
       <a class="mcnButton " href="{{url('boost/reset_password/'.'?email='.$user->email)}}" style="mso-line-height-rule: exactly;
    ...
    <a href="https://thenounproject.com/" style="mso-line-height-rule: exactly;
            ...
            font-weight: normal; text-decoration: none; color:#7F6925;" target="_blank" title="Noun Project - Icons for Everything"></div>
    </td>
    </tr>   
    </tbody>
    </table>                      
