                    ...
                    <div class="card-header">
                     ...
                     <div class="card-body order-datatable">
                        <table class="table table-borderd" id="dataTableNoPagingDesc">
                            ...
                            <tr>
                                <th width="50">Sl</th>
                                <th width="200">Promotion Head</th>
                                <th>Description</th>
                            ...
                            <tr>
                                ...
                                <td class="d-flex justify-content-between">
                                    <ul> 
                                        <li><a href="#" id="{{ url('/andbaazaradmin/promotionhead/'.$row->slug.'/edit' )}}" title="Edit"><button class="btn btn-sm btn-warning" data-toggle="modal" data-original-title="test" data-target="#promotionHeadEditModal{{$row->id}}"><i class="fa fa-edit"></i></button></a> </li>
                                        <li>
