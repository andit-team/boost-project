    ...
    <div class="container">
        <div class="col">
            <div>
                ...
                <form action="{{route('becomeAnAgentPost')}}" method="post" id="validateForm">
                    @csrf
                    <div class="row">
                        <div class="col-sm-6">
                            <input type="text" class="form-control @error('name') border-danger @enderror" required name="name" value="{{ old('name') }}"  placeholder="Enter Full Name">
                    ...
                    <button type="submit" class="btn btn-solid btn-sm">Become Agent</button>
                </form>
            </div>
        </div>
    </div>
