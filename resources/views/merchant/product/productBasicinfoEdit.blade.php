        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="form-group">
                    ...
                    <input type="text" readonly class="form-control @error('category') border-danger @enderror" required name="category" value="{{ old('name',$product->category_slug) }}" id="category" placeholder="Category">
