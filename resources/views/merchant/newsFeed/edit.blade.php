        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-9">
                 ...
                 <div class="card">
                        <div class="card-body">
                            <form class="them-form" action="{{ url('merchant/newsfeed/update/'.$newsFeed->slug) }}" method="post" enctype="multipart/form-data" id="validateForm">
                                @csrf
                                @method('put')
                                <div class="form-row">
                                    <div class="col-md-4 text-left">
                                        ...
                                        <div class="mt-0">
                                            @if(!empty($newsFeed->image))
                                            <img id="output" class="imagestyle" src="{{ asset($newsFeed->image) }}"/>
                                            @else
                                        ...
                                        <div class="uploadbtn">
                                            ...
                                            <input type="hidden" value="{{$newsFeed->image}}" name="old_image">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-row">
                                ...
                                <div class="form-row">
                                    <div class="col-md-12 mt-4">
                                        ...
                                        <textarea class="form-control summernote"  id="newsDesctiption"  name="news_desc">{{ $newsFeed->news_desc }}</textarea>
