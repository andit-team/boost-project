        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
          <div class="delivary-date-arae">
            ...
            <div class="shipping-product">
              ...
              <div class="form-group">
                <input type="text" name="postcode" id="postCode" class="form-control" placeholder="Postcode"  value="{{old('postcode',$user->postcode)}}">
                <span class="text-danger">{{$errors->first('postcode')}}</span> <br>
                <span class="btn btn-footer" id="lookUpAddress">Lookup Address</span>
              </div>
              <div class="form-group">
                <input type="text" class="form-control @error('address_1') border-danger @enderror" name="address_1" id="address1" required placeholder="Address Line 1" value="{{old('address_1',$user->address_1)}}">
                <span class="text-danger">{{$errors->first('address_1')}}</span>
              </div>
              <div class="form-group">
                <input type="text" class="form-control @error('address_2') border-danger @enderror" name="address_2" id="address2" placeholder="Address Line 2 (optional)" value="{{old('address_2',$user->address_2)}}">
                <span class="text-danger">{{$errors->first('address_2')}}</span>
              </div>
              <div class="form-group">
                <input type="text" class="form-control @error('town') border-danger @enderror" name="town" id="town" required placeholder="Town / City" value="{{old('town',$user->town)}}">
