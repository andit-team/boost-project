                    ...
                    <form class="theme-form" action="{{ route('profileUpdate') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6">
                                ...
                                @if($profile == '')
                                <input type="text" class="form-control datepicker @error('phone_number') border-danger @enderror" required name="dob" value="{{ old('dob',) }}" id="" placeholder="">
                                    
                                @else
                                <input type="text" class="form-control datepicker @error('phone_number') border-danger @enderror" required name="dob" value="{{ old('dob',$profile->dob) }}" id="" placeholder="">
