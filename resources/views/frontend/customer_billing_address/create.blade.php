                    ...
                    <form class="theme-form" action="{{ route('billing.store') }}" method="post" id="validateForm">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control inputfield @error('address') border-danger @enderror" name="address" value="{{old('address')}}" id="" placeholder="Address" required="">  
                            </div>
                            <div class="col-md-6">
                                <label for="country">Country <span class="text-danger"> *</span></label> <span class="text-danger">{{ $errors->first('address') }}</span> 
                                <input type="text" class="form-control inputfield @error('country') border-danger @enderror" name="country" value="{{old('country')}}" id="" placeholder="Country" required="">
                            </div>
                            <div class="col-md-6">
                                <label for="state">State <span class="text-danger"> *</span></label> <span class="text-danger">{{ $errors->first('state') }}</span>
                                    <input type="text" class="form-control inputfield @error('state') border-danger @enderror" name="state" value="{{old('state')}}" id="" placeholder="State" required="">  
                            </div>
                            <div class="col-md-6">
                                <label for="city">City <span class="text-danger"> *</span></label> <span class="text-danger">{{ $errors->first('city') }}</span> 
                                <input type="text" class="form-control inputfield @error('city') border-danger @enderror" name="city" value="{{old('city')}}" id="" placeholder="City" required=""> 
                            </div>
                            <div class="col-md-6">
                                <label for="zip_code">Zip Code <span class="text-danger"> *</span></label> <span class="text-danger">{{ $errors->first('zip_code') }}</span>
                                    <input type="text" class="form-control inputfield @error('zip_code') border-danger @enderror" name="zip_code" value="{{old('zip_code')}}" id="" placeholder="zip-code" required="">  
                            </div>
                            <div class="col-md-6">
                                <label for="phone">Phone <span class="text-danger"> *</span></label> <span class="text-danger">{{ $errors->first('phone') }}</span>
                                <input type="number" class="form-control inputfield @error('phone') border-danger @enderror" name="phone" value="{{old('phone')}}" id="" placeholder="Phone" required=""> 
                            </div>
                            <div class="col-md-6">
                                <label for="fax">Fax <span class="text-danger"> *</span></label> <span class="text-danger">{{ $errors->first('Fax') }}</span> 
                                <input type="string" class="form-control inputfield @error('fax') border-danger @enderror" name="fax" value="{{old('fax')}}" id="" placeholder="Fax" required="">
                            </div>
