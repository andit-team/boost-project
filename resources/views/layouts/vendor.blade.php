...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/vendor-dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Mar 2020 05:47:05 GMT -->
<head>
            ...
            <div class="col-sm-12">
                <div class="main-menu">
                    <div class="menu-left">
                                                ...
                                                <li>
                                                    <div class="row m-0">
                                                        ...
                                                        <div class="col-xl-4"><a href="#"
                                                                                 class="mega-menu-banner"><img src="{{ asset('') }}/assets/images/mega-menu/fashion.jpg" alt="" class="img-fluid blur-up lazyload"></a>
                                                        </div>
                                                    </div>
                                                </li>
                                            </ul>
                        ...
                        <div class="brand-logo"><a href="index.html"><img src="{{ asset('') }}/assets/images/icon/logo.png" class="img-fluid blur-up lazyload" alt=""></a></div>
                    </div>
                                                        ...
                                                        <div class="col mega-box">
                                                            <div class="link-section">
                                                                ...
                                                                <div class="menu-content">
                                                                    <ul>
                                                                        <li class="up-text"><a
                                                                                href="element-productbox.html">product box<span>10+</span></a></li>
                            ...
                            <div class="icon-nav">
                                <ul>
                                    <li class="onhover-div mobile-search">
                                        <div><img src="{{ asset('') }}/assets/images/icon/search.png" onclick="openSearch()" class="img-fluid blur-up lazyload" alt=""> <i class="ti-search" onclick="openSearch()"></i></div>
                                    ...
                                    <li class="onhover-div mobile-setting">
                                        <div><img src="{{ asset('') }}/assets/images/icon/setting.png" class="img-fluid blur-up lazyload" alt=""> <i class="ti-settings"></i></div>
                                    ...
                                    <li class="onhover-div mobile-cart">
                                        <div><img src="{{ asset('') }}/assets/images/icon/cart.png"  class="img-fluid blur-up lazyload" alt=""> <i class="ti-shopping-cart"></i></div>
                                        <ul class="show-div shopping-cart">
                                            <li>
                                                <div class="media">
                                                    <a href="#"><img class="mr-3"  src="{{ asset('') }}/assets/images/fashion/product/1.jpg" alt="Generic placeholder image"></a>
                                            ...
                                            <li>
                                                <div class="media">
                                                    <a href="#"><img class="mr-3" src="{{ asset('') }}/assets/images/fashion/product/2.jpg" alt="Generic placeholder image"></a>
                                                    <div class="media-body">
                                                        <a href="#">
                                                            <h4>item name</h4>
                                                        </a>
                    ...
                    <div class="col-lg-6">
                        <form action="https://pixelstrap.us19.list-manage.com/subscribe/post?u=5a128856334b598b395f1fc9b&amp;id=082f74cbda" class="form-inline subscribe-form auth-form needs-validation" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" target="_blank">
                            <div class="form-group mx-sm-3">
                                <input type="text" class="form-control" name="EMAIL" id="mce-EMAIL" placeholder="Enter your email" required="required"></div>
...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/vendor-dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Mar 2020 05:47:10 GMT -->
</html>
