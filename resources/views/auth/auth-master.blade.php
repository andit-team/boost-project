...
<head>
    ...
    <link rel="icon" href="{{asset('frontend')}}/assets/images/favicon/" type="image/x-icon">
    <link rel="shortcut icon" href="{{asset('frontend')}}/assets/images/favicon/" type="image/x-icon">
    <title>Boost Merchant</title>
