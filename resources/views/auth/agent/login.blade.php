        ...
        <div class="card tab2-card">
            <div class="card-body">
                <ul class="nav nav-tabs nav-material" id="top-tab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="top-profile-tab" data-toggle="tab" href="#top-profile" role="tab" aria-controls="top-profile" aria-selected="true"><span class="icon-user mr-2"></span>Agent Login</a>
                    </li>
                </ul>
                    ...
                    @endif
                        ...
                        <form class="form-horizontal auth-form" method="post" action="{{route('agentloginprocess')}}" id="validateForm">
                            @csrf
                            <div class="form-group">
                                <input required="" name="login[email]" type="email"  value="agent@andit.com" class="form-control @error('email') border-danger @enderror" placeholder="Email" id="exampleInputEmail1">
                            ...
                            <div class="form-terms">
                                <div class="custom-control custom-checkbox mr-sm-2">
                                    ...
                                    <a href="{{url('agent/forgot_password')}}" class="btn btn-default forgot-pass">Forget password</a>
                                </div>
                            </div>
