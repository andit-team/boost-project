            ...
            <div class="single-item">
                <div>
                    <div>
                        ...
                        <p> Became a agent on Andbaazar all you need is to register."                         ,
        ...
        <div class="card tab2-card">
            <div class="card-body">
                <ul class="nav nav-tabs nav-material" id="top-tab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link" id="contact-top-tab" data-toggle="tab" href="#top-contact" role="tab" aria-controls="top-contact" aria-selected="false"><span class="icon-unlock mr-2"></span>Agent Register</a> 
                    </li>
                </ul>
                    ...
                    <form class="form-horizontal auth-form" action="{{ route('profileRegistration') }}" method="post" enctype="multipart/form-data" id="validateForm">
                        @csrf 
                            <div class="form-group">
                                <input required="" name="verification_token"  type="hidden" value="{{ $agent->verification_token }}"  class="form-control" placeholder="varification Code" id="exampleInputEmail12">
