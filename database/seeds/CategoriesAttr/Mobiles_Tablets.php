            ...
            [
                ...
                'attr'	=> [
                    ...
                    [
                        ...
                        'type'          => 'number',
                        'required'      => 1,
                        'suggestion'    => 'Size of the tablet screen in inchesValid Value must be a number. The separator between the integer part and the fractional part should be a dot. 1 digit is allowed after the dot.',
                    ],
                    [
