...
{
    use SoftDeletes;
    protected $fillable = ['name','bn_name','image','slug','price','model_no','org_price','pack_id','sorting','description','email','bn_description','rej_desc','min_order','available_on','availability','made_in','materials','labeled','video_url','total_sale_amount','total_order_qty','last_ordered_at','last_carted_at','total_view','brand_id','activated_at','active','user_id','shop_id','category_id','category_slug','tag_slug','status' ];
